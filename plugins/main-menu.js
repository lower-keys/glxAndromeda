  ...
  try {
    ...
    if (teks == '404') {
      ...
      const sections = [
      {
        ...
        rows: [
          { title: 'All Menu', rowId: `${_p + command} all` },
          ...
          { title: 'Voice Changer', rowId: `${_p + command} audio` },
          { title: 'Jadi Bot', rowId: `${_p + command} jadibot` },
          { title: 'Info', rowId: `${_p +command} info` },
          { title: 'No Category', rowId: `${_p + command} tanpakategori` },
...
*STATUS INFO*
Request pull : ${rtotalreg} dari ${totalreg}
Remaining Limit : ${limit} Limit
Role : ${role}
Level : *${level}*
